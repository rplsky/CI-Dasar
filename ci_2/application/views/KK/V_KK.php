        ...
        <tbody>
            ...
            ?>
                    <tr>
                        ...
                        <td><a href="<?php echo site_url('C_Keluarga/index/').$d_kk->no_kk;?>">Tampil Anggota Keluarga</a> | <a href="<?php echo site_url('C_KK/form_edit_kk/').$d_kk->no_kk;?>">Edit Data</a> | <a href="<?php echo site_url('C_KK/hapus_kk/').$d_kk->no_kk;?>" onclick="return confirm('Anda akan menghapus data ini?')">Hapus Data</a></td>
                    </tr>
            <?php        
                }
            ?>
